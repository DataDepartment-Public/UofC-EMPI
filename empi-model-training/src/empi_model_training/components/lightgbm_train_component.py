"""Azure ML component definition for LightGBM v5 pair-classifier training.
...
COMPONENT_NAME = "lightgbm_v5_train"
...
def build_lightgbm_train_component(
    ...
    built = command(
        name=COMPONENT_NAME,
        display_name="Train LightGBM v5 confident-match classifier",
        description=(
            "Independent implementation (see empi-model-training/CLAUDE.md) of the "
            "confident-match classifier documented in "
            "empi-service/docs/ML-Model-LightGBM-v5.md."
        ),
        inputs={
