...
Usage:
    uv run python scripts/research_fs_splink_r3.py [--qgram-threshold 0.30] [--cnp-k 10]
"""
...
from scripts.research_blocking_scalable import arcs_weights, block_then_qgram, cnp_prune
from scripts.research_fs_splink import _add_concat, _prep
...
def freeze_stacked_blocker(
    ...
    # (mirrors scripts/research_blocking_round4.stacked_pipeline).
