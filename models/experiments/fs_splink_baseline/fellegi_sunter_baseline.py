"""
fellegi_sunter_baseline.py — Fellegi-Sunter probabilistic record linkage baseline
...
----------
    ...
    run_fs_baseline(candidate_pairs_path, df_clean)  -> pd.DataFrame

OUTPUT CONTRACT
---------------
run_fs_baseline() returns the standardized five-column evaluation frame by
...
# phase. To be poolable and comparable across models, run_fs_baseline() returns
...
# available via run_fs_baseline(..., full_output=True) for this model's own
