"""Sandbox runner for fs_splink_enhanced_3.
...
and the test-split confusion matrix is sane.

USAGE:
    python -m models.experiments.fs_splink_enhanced_3.run_synthetic_enhanced_3

OUTPUT:
    Prints tier counts + test-split confusion matrix to stdout. No on-disk
    artifacts (sandbox).
"""
...
from models.experiments.fs_splink_enhanced_3.fs_enhanced_3 import FSEnhanced3  # noqa: E402
...
logger = logging.getLogger("fs_enhanced_3.sandbox")
...
def main() -> None:
    ...
    # full 7-comparison registry + all prior rules apply. u_max_pairs=1e4 is safe
